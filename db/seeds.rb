...
m1 = Memory.create(title: "Trip to the Dunes", category: "vacation", status: "past", main_img: "https://www.nps.gov/common/uploads/grid_builder/grsa/crop16_9/2E8879CA-EF95-283E-C88B7FE90F149C36.jpg?width=950&quality=90&mode=crop", description: "Mel and I went to the Sand Dunes and had a lovely time.", likes: 5, user_id: u2.id)
m2 = Memory.create(title: "Wedding: Season 2", category: "celebration", status: "past", main_img: "https://ktrg.net/wp-content/uploads/2020/10/Loft-Entrance-Front-View-1.jpg", description: "Melody's wedding was as magical as she is.", likes: 600, user_id: u2.id)
m3 = Memory.create(title: "Wedding: Season 1", category: "celebration", status: "past", main_img: "https://i0.wp.com/jeanhedrenrealtor.com/wp-content/uploads/2021/05/Heilig-34.jpg?fit=1200%2C800&ssl=1", description: "Jon's wedding was the dopest dope I've ever smoked! SEND THAT SHIIIIT!", likes: 25, user_id: u3.id)
m4 = Memory.create(title: "Daddaroo at Hilton Head", category: "celebration", status: "past", main_img: "https://s7.bluegreenvacations.com/is/image/BGV/south-carolina-hilton-head-island-lighthouse?$bg2-hero-lg$", description: "We had a lovely time.", likes: 15, user_id: u5.id)
...
m7 = Memory.create(title: "Baby P is Coming Soon!", category: "event", status: "present", main_img: "https://res.cloudinary.com/babylist/image/upload/f_auto,q_auto:best,c_scale,w_1200/v1581022086/hello-baby/baby-shower-theme-header.jpg", description: "We're so excited to welcome Baby P in April", likes: 34, user_id: u11.id)
m8 = Memory.create(title: "Hamilton at the DCPA", category: "event", status: "past", main_img: "https://upload.wikimedia.org/wikipedia/en/8/83/Hamilton-poster.jpg", description: "We went to see Hamilton at the DCPA", likes: 2, user_id: u3.id)
m9 = Memory.create(title: "Cats at the DCPA", category: "event", status: "past", main_img: "https://static01.nyt.com/images/2016/07/24/arts/06ALW2/24cats-lead-superJumbo-v5.jpg", description: "We unfortunately saw cats and left at intermission", likes: 0, user_id: u3.id)
m10 = Memory.create(title: "Improvised Shakespeare", category: "event", status: "past", main_img: "https://apeconcerts.com/wp-content/uploads/2018/05/theimprovisedshakespearecomapny_1024-1024x574.jpg", description: "Improvised Shakespeare; only SOUNDS like a bad idea, but never is.", likes: 4, user_id: u2.id)
